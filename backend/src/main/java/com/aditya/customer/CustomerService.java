...
import com.aditya.exception.RequestValidationException;
import com.aditya.exception.ResourceNotFoundException;
import com.aditya.s3.S3Buckets;
import com.aditya.s3.S3Service;
...
public class CustomerService {
    ...
    public void deleteCustomerById(Integer customerId) {
        checkIfCCustomerExistsOrThrow(customerId);
        customerDao.deleteCustomerById(customerId);
    }

    private void checkIfCCustomerExistsOrThrow(Integer customerId) {
